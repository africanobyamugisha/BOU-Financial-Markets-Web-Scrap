...
df <- read_excel(dt, sheet = grep(dt, excel_sheets(dt), value = TRUE),
...
excel_sheets(dt)
grep("data", excel_sheets(dt), value = TRUE)

# get the names of all sheets in the Excel file
sheet_names <- excel_sheets(path)

# filter the sheet names based on the given string
desired_sheet_name <- grep("data", excel_sheets(dt), value = TRUE)

# read the data from the desired sheet
data <- read_excel(path, sheet = desired_sheet_name)
